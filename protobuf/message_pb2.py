...
_PACKET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='from', full_name='Packet.from', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='to', full_name='Packet.to', index=3,
...
_PACKET.fields_by_name['from'].message_type = _VERIFICATIONKEY
_PACKET.fields_by_name['to'].message_type = _VERIFICATIONKEY
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\030com.shuffle.player.protoB\005Proto'))
